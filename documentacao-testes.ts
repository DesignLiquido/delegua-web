import { MetodoDocumentacao } from "./interfaces";

export const DocumentacaoModuloAfirmar: { [metodo: string]: MetodoDocumentacao } = {
    igual: {
        tipoRetorno: 'vazio',
        argumentos: [
            { nome: 'esperado' },
...
const documentacaoPular = (funcaoOuGrupo: 'teste' | 'grupo'): MetodoDocumentacao => ({
    tipoRetorno: 'vazio',
    argumentos: [
        { nome: 'nome' },
        { nome: 'funcao' }
...
const documentacaoApenas = (funcaoOuGrupo: 'teste' | 'grupo'): MetodoDocumentacao => ({
    tipoRetorno: 'vazio',
    argumentos: [
        { nome: 'nome' },
        { nome: 'funcao' }
...
export const DocumentacaoModuloTeste: { [metodo: string]: MetodoDocumentacao } = {
    pular: documentacaoPular('teste'),
    apenas: documentacaoApenas('teste'),
};

export const DocumentacaoModuloGrupo: { [metodo: string]: MetodoDocumentacao } = {
